...
if [ $OSTYPE == 'linux-gnu' ]; then
    ...
    # Mac OS X Paths
    export PATH="$(brew --prefix coreutils)/libexec/gnubin:/usr/local/opt/go/bin:/Library/Frameworks/Python.framework/Versions/2.7/bin:/usr/local/share/npm/bin:/usr/local/sbin:/usr/local/bin:${PATH}"
    # Enable Bash Completion
