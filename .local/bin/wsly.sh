...
if ! command -v zsh >/dev/null 2>&1; then
  ...
  # Tools
  sudo apt install amazon-ecr-credential-helper curl direnv dnsutils eza fd-find ffmpeg imagemagick jq libsixel-bin mosh nmap ntpdate ripgrep stow tmux unzip vim wget wl-clipboard wslu xdg-utils zip
  ...
  asdf install packer 1.15.3
  asdf set -u packer 1.15.3
  ...
  npm install -g @earendil-works/pi-coding-agent agent-browser npm-check-updates
