...
if [[ ! $(zsh --version) ]]; then
  ...
  # Tools
  sudo apt install direnv dnsutils eza fd-find gh git-crypt jq nmap ntpdate ripgrep stow unzip wslu xdg-utils zip
  ...
  nvm use default
  npm install -g @openai/codex @anthropic-ai/claude-code @ast-grep/cli npm-check-updates
