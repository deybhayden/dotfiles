...
if ! command -v zsh >/dev/null 2>&1; then
  ...
  # Tools
  sudo apt install amazon-ecr-credential-helper curl direnv dnsutils eza fd-find ffmpeg imagemagick jq libsixel-bin nmap ntpdate ripgrep stow tmux unzip vim wget wl-clipboard wslu xdg-utils zip
