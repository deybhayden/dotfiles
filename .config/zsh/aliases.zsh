...
alias pi-opus="pi --provider github-copilot --model claude-opus-4.6 --thinking high"
alias pi-sonnet="pi --provider github-copilot --model claude-sonnet-4.6 --thinking medium"
alias pi-gemini="pi --provider google-gemini-cli --model gemini-3.1-pro-preview --thinking high"
