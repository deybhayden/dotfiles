...
function pi-bb-review() {
  pi --offline --provider openai-codex --model gpt-6-astra --thinking xhigh "/bitbucket review $@"
}

function pi-bb-respond() {
  pi --offline --provider openai-codex --model gpt-6-astra --thinking high "/bitbucket respond $@"
}

function pi-gh-review() {
  pi --offline --provider openai-codex --model gpt-6-astra --thinking xhigh "/github review $@"
}

function pi-gh-respond() {
  pi --offline --provider openai-codex --model gpt-6-astra--thinking high "/github respond $@"
}